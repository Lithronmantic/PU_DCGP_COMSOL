"""Reference equations for the H11 spherical 7YSZ radial-enthalpy model."""
...
def radial_enthalpy_rhs(
    ...
    *,
    ...
    """Return d(h_i)/dt for finite-volume spherical shells."""
...
def comsol_shell_rhs_expressions(
    ...
    """Create conservative finite-volume shell RHS expressions for COMSOL."""
