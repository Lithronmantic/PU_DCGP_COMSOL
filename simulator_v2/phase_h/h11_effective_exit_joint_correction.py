"""Run the single preregistered interaction-aware effective-exit correction."""
...
from simulator_v2.phase_h.h11_effective_exit_joint_correction_contract import (
    OUTPUT_PATH as CONTRACT_PATH,
    JointCorrectionContract,
)
from simulator_v2.phase_h.h11_effective_exit_joint_screen import (
