"""Audit the existing three-level target-impact mesh ladder.

The script reports convergence evidence; it never forces a GCI estimate when
the three solutions are outside an asymptotic range.
"""
...
def audit_quantity(
    ...
    *,
    ...
    """Audit one scalar ordered as coarse, medium, fine."""
