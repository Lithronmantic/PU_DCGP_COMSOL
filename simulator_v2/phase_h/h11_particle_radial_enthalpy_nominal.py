"""Build and optionally solve the H11 nominal radial-enthalpy particle case."""
...
from simulator_v2.phase_h.h11_radial_enthalpy_model import (
...
def _particle_local_expressions(
    ...
    """Expressions evaluated on the Lagrangian particle geometry."""
...
def _configure_study(
    ...
    # The default second-order Newtonian form is more robust for the abrupt
    # drag acceleration; particle velocity is read through fpt.vr/fpt.vz.
...
def build_model(
    ...
    """Attach the frozen particle physics to one accepted gas-field model."""
...
def _configure_implicit_particle_solver(
    ...
    """Lock the stiff particle/enthalpy integration to generalized-alpha."""
...
def _first_plane_crossings(
    ...
    *,
    ...
    """Linearly interpolate the first crossing of an axial observation plane."""
