"""Build the H11 v2 particle-population tree on the accepted gas field.

The model is intentionally build-only.  It verifies the correct gas-model
lineage, seven 7YSZ diameter nodes, wide-Re drag, open boundaries, and a fixed
100 mm observation coordinate before release or thermal-shell equations are
added.
"""
