"""Read-only open-boundary diagnostic for the H11 all-Mach target branch."""
...
from simulator_v2.phase_h.h11_mass_balance_equation_audit import (
...
def flow_partition(
    ...
    """Return signed flow and direction fractions from positive magnitudes."""
