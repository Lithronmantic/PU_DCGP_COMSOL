...
from pu_dcgp_comsol.comsol.target_impact_conservative_domain_independence import (
...
def finalize_domain_continuation(
    ...
    outer_limits = {
        ...
        "common_speed": (
            float(outer_fields["speed_normalized_l2"]),
            contract.common_speed_l2_limit_fraction,
        ),
        "common_pressure": (
            float(outer_fields["pressure_l2_over_ambient"]),
    ...
    contraction_pairs = {
        ...
        "common_speed": (
            float(inner_fields["speed_normalized_l2"]),
            float(outer_fields["speed_normalized_l2"]),
        ),
        "common_pressure": (
            float(inner_fields["pressure_l2_over_ambient"]),
            float(outer_fields["pressure_l2_over_ambient"]),
        ),
    }
    contraction_gates = {
